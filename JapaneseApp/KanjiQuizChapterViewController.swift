//
//  KanjiQuizChapterViewController.swift
//  JapaneseApp
//
...
class KanjiQuizChapterViewController: UITableViewController{
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if destinationvc is  KanjiQuizViewController{
            if let identifier = segue.identifier {
                switch identifier{
                    
                case "ShowChapter3":
                    if let kanjivc = destinationvc as? KanjiQuizViewController{
                        let correctDictionary:[String:String] = list.Chapter3KanjiList           //load the appropriate dictionary
                        kanjivc.appropriateDictionary = correctDictionary                         //send it to the appropriate destination 
                    }
                    break
                case "ShowChapter4":
                    if let kanjivc = destinationvc as? KanjiQuizViewController{
